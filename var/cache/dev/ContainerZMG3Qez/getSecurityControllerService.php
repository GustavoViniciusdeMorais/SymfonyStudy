...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.7ach85B'] ?? $container->load('get_ServiceLocator_7ach85BService'))->withContext('App\\Controller\\SecurityController', $container));
